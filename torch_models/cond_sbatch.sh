...
python old_generate.py --arch=$ARCH --outf=$ARCH --checkpoint=$FILE_NAME --vocabf=$VOCABF --corpusf=$CORPUSF --num_out=5 --condition_piece="../music_data/CMaj_Nottingham/train/jigs_simple_chords_189.mid" --condition_notes=$CONDITION_NOTES --window=$WINDOW --distance_threshold=$DISTANCE_THRESHOLD --temperature=$TEMPERATURE --c=$C --most_recent 
